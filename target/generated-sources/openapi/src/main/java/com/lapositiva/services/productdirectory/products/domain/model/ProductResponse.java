...
public class ProductResponse {
  ...
  */
  ...
  @Schema(name = "code", example = "P001", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("code")
  ...
  */
  ...
  @Schema(name = "name", example = "Seguro de Vida", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("name")
